...
2. Add your personal information to `people` sheets. Refer to tips when you fill out each data. You can find tips if you hover cells on top
3. Add your project information to `projects` sheets. 
4. Create your project folder with your project id under the `assets` folder and upload all images and videos of your projects
